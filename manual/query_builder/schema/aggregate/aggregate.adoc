...
https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html[SchemaBuilder] offers API methods for creating and dropping aggregates.

=== Creating an aggregate (CREATE AGGREGATE)

To start a `CREATE AGGREGATE` query, use `createAggregate` in https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/querybuilder/SchemaBuilder.html[SchemaBuilder]:
