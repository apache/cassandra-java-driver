...
If you are reusing code that configures SSL programmatically, you can use https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/ssl/ProgrammaticSslEngineFactory.html[ProgrammaticSslEngineFactory] as an easy way to wrap that into a factory instance:
