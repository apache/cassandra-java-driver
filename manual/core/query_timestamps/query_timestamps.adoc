...
* programmatically with https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/cql/Statement.html#setQueryTimestamp-long-[Statement.setQueryTimestamp()].
...
You can create your own generator by implementing https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/time/TimestampGenerator.html[TimestampGenerator], and referencing your implementation class from the configuration.
