...
Alternatively, you can use https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html#programmaticBuilder--[DriverConfigLoader.programmaticBuilder] to specify configuration options programmatically instead of loading them from a static resource:
...
The driver's context exposes a https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/config/DriverConfig.html[DriverConfig] instance:
...
https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/config/DriverExecutionProfile.html[DriverExecutionProfile] has typed option getters:
...
Then write a https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/config/DriverConfigLoader.html[DriverConfigLoader] and pass it to the session at  initialization, as shown in the previous sections.
...
Where https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/context/DriverContext.html[DriverContext] is the object returned by `session.getContext()`, which allows the policy to access other driver components (for example the configuration).
...
First, write an enum that implements https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/config/DriverOption.html[DriverOption]:
