...
Attributes can also be provided statically by annotating the method with https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/mapper/annotations/StatementAttributes.html[@StatementAttributes]:
