...
*/
    ...
    public Object getObject(int index) throws SQLException
    {
        ...
        return null; // A remplacer par un traitement conditionnel pour récupérer le bon type de donnée
    }
    ...
    {
        checkIndex(index);
        //return currentRow.getgetRowId(values.get(index - 1));
    }
    ...
    private final RowId getRowId(Object column) throws SQLException
    {
        checkNotClosed();
        ByteBuffer value = (ByteBuffer)column;
        wasNull = value == null;
