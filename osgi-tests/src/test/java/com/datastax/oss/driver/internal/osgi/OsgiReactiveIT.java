...
public class OsgiReactiveIT {
  ...
  @Test
  public void test_reactive() throws Exception {
    DefaultServiceChecks.checkService(service);
    assertThat(service).isInstanceOf(ReactiveMailboxService.class);
    ReactiveServiceChecks.checkServiceReactive((ReactiveMailboxService) service);
  }
}
