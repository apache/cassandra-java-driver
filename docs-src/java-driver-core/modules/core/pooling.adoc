...
You simply interact with a https://docs.datastax.com/en/drivers/java/4.14/com/datastax/oss/driver/api/core/CqlSession.html[CqlSession] object, which takes care of it.
