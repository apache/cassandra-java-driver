...
[e.g.
3.1.1](https://github.com/datastax/java-driver/tree/3.1.1).*
...
The Java client driver 3.1.1 ([branch 3.0](https://github.com/datastax/java-driver/tree/3.0)) is compatible with Apache
