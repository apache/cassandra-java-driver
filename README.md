...
[e.g.
3.0.6](https://github.com/datastax/java-driver/tree/3.0.6).*
...
- DOCS: the [manual](http://docs.datastax.com/en/developer/java-driver/3.0/manual/) has quick
  start material and technical details about the driver and its features.
- API: http://www.datastax.com/drivers/java/3.0
- [changelog](changelog/)
- [binary tarball](http://downloads.datastax.com/java-driver/cassandra-java-driver-3.0.6.tar.gz)
...
The Java client driver 3.0.6 ([branch 3.0.x](https://github.com/datastax/java-driver/tree/3.0.x)) is compatible with Apache
