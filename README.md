...
[e.g.
3.0.0-beta1](https://github.com/datastax/java-driver/tree/3.0.0-beta1).*
...
[binary tarball](http://downloads.datastax.com/java-driver/cassandra-java-driver-3.0.0-beta1.tar.gz)
