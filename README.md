...
[e.g.
3.1.2](https://github.com/datastax/java-driver/tree/3.1.2).*
...
- [changelog](changelog/)
- [binary tarball](http://downloads.datastax.com/java-driver/cassandra-java-driver-3.1.2.tar.gz)
...
The Java client driver 3.1.2 ([branch 3.1](https://github.com/datastax/java-driver/tree/3.1)) is compatible with Apache
