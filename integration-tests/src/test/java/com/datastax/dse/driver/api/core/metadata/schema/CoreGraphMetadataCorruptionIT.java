...
public class CoreGraphMetadataCorruptionIT {
  ...
  @Test
  public void should_tolerate_vertex_metadata_corruption() {
    SESSION_RULE.session().execute("TRUNCATE system_schema.vertices");
    SESSION_RULE.session().refreshSchema();
  }
}
