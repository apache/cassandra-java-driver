...
public class GraphTestSupport {
  ...
  /**
   * CCM Rule builder for serial and isolated Graph Data Type tests.
   *
   * <p>Only use this when you need additional configuration of the CCM rule. Otherwise, use the
   * shared {@link CcmRule} (it has graph capability) and make the test parallelizable.
   */
   ...
   */
  public static CqlSessionRuleBuilder getClassicGraphSessionBuilder(CassandraResourceRule ccmRule) {
   ...
   */
  public static CqlSessionRuleBuilder getCoreGraphSessionBuilder(CassandraResourceRule ccmRule) {
    return new CqlSessionRuleBuilder(ccmRule)
        .withCreateGraph()
        .withCoreEngine()
