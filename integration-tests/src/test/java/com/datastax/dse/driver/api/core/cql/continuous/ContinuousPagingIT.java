...
public class ContinuousPagingIT extends ContinuousPagingITBase {
  ...
  public void should_cancel_with_asynchronous_paging() {
    ...
    try {
      ...
      /**
       * Since Java 25 has a breaking change in CompletableFuture.get() See:
       * https://github.com/openjdk/jdk/commit/8a4315f833f3700075d65fae6bc566011c837c07
       * CancellationException will be wrapped in a new CancellationException, with "get" as the
       * message, and the original CancellationException as the cause
       */
      boolean exceptionHasBothMessages =
          e.getMessage() != null
              && e.getMessage().contains("Can't get more results")
              && e.getMessage().contains("query was cancelled");

      boolean causeHasBothMessages =
          e.getCause() != null
