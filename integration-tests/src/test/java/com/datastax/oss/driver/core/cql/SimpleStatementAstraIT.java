...
public class SimpleStatementAstraIT {

  private static final AstraRule ASTRA_RULE = AstraRule.getInstance();

  private static final SessionRule<CqlSession> SESSION_RULE =
      SessionRule.builder(ASTRA_RULE)
          .withConfigLoader(
  ...
  @ClassRule
  public static final TestRule CHAIN = RuleChain.outerRule(ASTRA_RULE).around(SESSION_RULE);
