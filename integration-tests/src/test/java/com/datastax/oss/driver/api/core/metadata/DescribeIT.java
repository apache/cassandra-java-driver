...
public class DescribeIT {
  ...
  public void create_schema_and_ensure_exported_cql_is_as_expected() {
    ...
    if (ccmRule.getCassandraVersion().compareTo(CassandraVersions.CASSANDRA_2_2_0) >= 0) {
      ...
      if (ccmRule.getCassandraVersion().compareTo(CassandraVersions.CASSANDRA_3_0_0) >= 0) {
