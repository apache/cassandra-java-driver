 ...
 *
 * <p>Implementation notes: this class is abstract and not meant to use directly. The type parameter
 * {@code T} allows usage of <strong>covariant return type</strong> and makes the builder pattern
 * work for different sub-classes.
 *
 * @param <T> the concrete sub-class of {@link com.datastax.driver.core.schemabuilder.TableOptions}
 * @see <a href="http://docs.datastax.com/en/cql/3.1/cql/cql_reference/tabProp.html"
 *     target="_blank">details on table options</a>
 */
public abstract class TableOptions<T extends TableOptions> extends SchemaStatement {
   ...
   *
   * <p>If no call is made to this method, the default value set by Cassandra is {@link
   ...
   *
   * <p>If no call is made to this method, the default values set by Cassandra are keys = {@link
   ...
   *
   * <p>If no call is made to this method, the default value set by Cassandra is:
   *
   * <ul>
   ...
   * center.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 0.0.
   *
   ...
   * <p>
   *
   * <p>Used in MapReduce/Hive scenarios when you have no control of TTL.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 0.
   *
   ...
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 864000 secs (10
   * days).
   *
   ...
   *
   * <p>To control the sampling of entries from the primary row index, configure sample frequency of
   ...
   * read performance.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 128.
   *
   ...
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 2048.
   *
   ...
   *
   * <p>If set, this forces flushing of the memtable after the specified time elapses.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 0.
   *
   ...
   *
   * <p>If set, Cassandra adds newly flushed or compacted sstables to the operating system page
   * cache, potentially evicting other cached data to make room. Enable when all data in the table
   * is expected to fit in memory.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is {@code false}.
   *
   * @param populateIOOnCacheFlush whether to populate IO cache on flush of sstables.
   * @return this {@code TableOptions} object.
   * @see <a
   *     href="http://docs.datastax.com/en/cassandra/2.0/cassandra/configuration/configCassandra_yaml_r.html?scroll=reference_ds_qfg_n1r_1k__compaction_preheat_key_cache">the
   *     global option compaction_preheat_key_cache</a>
   */
   ...
   *
   * <p>If no call is made to this method, the default value set by Cassandra is 0.1.
   *
   ...
   *
   * <p>When set to {@code true}, replicates writes to all affected replicas regardless of the
   * consistency level specified by the client for a write request. For counter tables, this should
   * always be set to {@code true}.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is {@code true}.
   *
   ...
   * <p>
   *
   * <p>If no call is made to this method, the default value set by Cassandra is {code
   * 99percentile}.
   *
   ...
   *
   * <p>Note that using this option with a version of Apache Cassandra less than 3.8 will raise a
   * syntax error.
   *
   * <p>If no call is made to this method, the default value set by Cassandra is {@code false}.
   *
   ...
   *
   * <p>This method is provided as a fallback if the SchemaBuilder is used with a more recent
   ...
   *
   * <p>To create instances, use {@link SchemaBuilder#sizedTieredStategy()}, {@link
   * SchemaBuilder#leveledStrategy()}, {@link SchemaBuilder#dateTieredStrategy()} or {@link
   * SchemaBuilder#timeWindowCompactionStrategy()}
   */
  public abstract static class CompactionOptions<T extends CompactionOptions> {
     ...
     *
     * <p>If no call is made to this method, the default value set by Cassandra is 1.
     *
     ...
     *
     * <p>If no call is made to this method, the default value set by Cassandra is 0.2.
     *
    ...
    public static class SizeTieredCompactionStrategyOptions
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 1.5.
       *
       ...
       * bucket_high values: [average-size × bucket_low, average-size × bucket_high].
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 0.5.
       *
       ...
       * cold_reads_to_omit property to tune performace per table. The <a
       * href="http://www.datastax.com/dev/blog/optimizations-around-cold-sstables">Optimizations
       * around Cold SSTables</a> blog includes detailed information tuning performance using this
       * property, which avoids compacting cold SSTables. Use the ALTER TABLE command to configure
       * cold_reads_to_omit.
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 0.0 (disabled).
       *
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 4.
       *
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 32.
       *
       ...
       * one unique bucket
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 52428800 (50
       * MB).
       *
    ...
    public static class LeveledCompactionStrategyOptions
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 160.
       *
    ...
    public static class DateTieredCompactionStrategyOptions
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 3600 (1 hour).
       *
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is 365.
       *
    ...
    public static class TimeWindowCompactionStrategyOptions
        extends CompactionOptions<TimeWindowCompactionStrategyOptions> {
       ...
       *
       * <p>If no call is made to this method, the default value set by Cassandra is {@code DAYS}.
       *
       ...
       * re-appearing.
       *
       * <p>If no call is made to this method, the default value set by Cassandra is false.
       *
   ...
   *
   * <p>To create instances, use {@link SchemaBuilder#noCompression()}, {@link SchemaBuilder#lz4()},
  ...
  public static class CompressionOptions {
     ...
     *
     * <p>If no call is made to this method, the default value set by Cassandra is 54.
     *
     ...
     *
     * <p>If no call is made to this method, the default value set by Cassandra is 1.0 (always
     * check).
     *
   ...
   *
   * <p>To create instances, use {@link SchemaBuilder#noSpeculativeRetry()}, {@link
   ...
   *
   * <p>To create instances, use {@link SchemaBuilder#noRows()}, {@link SchemaBuilder#allRows()} or
