...
public abstract class GuavaCompatibility {
   ...
   */
  public abstract <I, O> ListenableFuture<O> transformAsync(
   ...
   */
  public abstract <I, O> ListenableFuture<O> transformAsync(
      ListenableFuture<I> input, AsyncFunction<? super I, ? extends O> function, Executor executor);
  ...
  private static boolean methodExists(
    ...
    try {
      ...
      logger.debug(
          "Error while checking existence of method "
