...
public class Insert extends BuiltStatement {
   ...
   * Cassandra 2.2.
   *
   * <p>With INSERT statements, the new {@code JSON} keyword can be used to enable inserting a JSON
   ...
   *       CodecRegistry} in use. This allows the usage of JSON libraries, such as the <a
   *       href="https://jcp.org/en/jsr/detail?id=353">Java API for JSON processing</a>, the popular
   *       <a href="http://wiki.fasterxml.com/JacksonHome">Jackson</a> library, or Google's <a
   ...
   *
   * <p>For example, to insert into a table with two columns named “myKey” and “value”, you would do
   * the following:
   *
   * <pre>
   ...
   * @see <a href="https://docs.datastax.com/en/cql/3.3/cql/cql_using/useInsertJSON.html">Inserting
   *     JSON data</a>
   */
   ...
   *
   * <p>Support for {@code DEFAULT UNSET} has been introduced in Cassandra 3.10.
   *
   * @return this {@code INSERT} statement.
   * @throws IllegalStateException if this method is called and any of the {@code value} or {@code
   *     values} methods have been called before, because it's not possible to mix {@code INSERT
   ...
   *
   * <p>Support for {@code DEFAULT NULL} has been introduced in Cassandra 3.10.
   *
   * @return this {@code INSERT} statement.
   * @throws IllegalStateException if this method is called and any of the {@code value} or {@code
   *     values} methods have been called before, because it's not possible to mix {@code INSERT
