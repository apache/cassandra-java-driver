...
public class Policies {
  ...
  private static final ReconnectionPolicy DEFAULT_RECONNECTION_POLICY =
      new ExponentialReconnectionPolicy(1000, 10 * 60 * 1000);
  ...
  private static final SpeculativeExecutionPolicy DEFAULT_SPECULATIVE_EXECUTION_POLICY =
   ...
   *
   * <p>The default load balancing policy is {@link DCAwareRoundRobinPolicy} with token awareness
   * (so {@code new TokenAwarePolicy(new DCAwareRoundRobinPolicy())}).
   *
   ...
   *
   * <p>The default reconnection policy is an {@link ExponentialReconnectionPolicy} where the base
   ...
   *
   * <p>The default retry policy is {@link DefaultRetryPolicy}.
   *
   ...
   *
   * <p>The default address translator is {@link IdentityTranslator}.
   *
   ...
   *
   * <p>This is an instance of {@link AtomicMonotonicTimestampGenerator}.
   *
   ...
   *
   * <p>The default speculative retry policy is a {@link NoSpeculativeExecutionPolicy}.
   *
   ...
   *
   * <p>The load balancing policy defines how Cassandra hosts are picked for queries.
   *
   ...
   *
   * <p>The reconnection policy defines how often the driver tries to reconnect to a dead node.
   *
   ...
   *
   * <p>The retry policy defines in which conditions a query should be automatically retries by the
   * driver.
   *
