...
public class Update extends BuiltStatement {
   ...
   *
   * <p>This is a shorter/more readable version for {@code with().and(assignment)}.
   *
   ...
   *
   * <p>When provided some conditions, an update will not apply unless the provided conditions
   * applies.
   *
   * <p>Please keep in mind that provided conditions has a non negligible performance impact and
