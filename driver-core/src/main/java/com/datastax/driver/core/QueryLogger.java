 ...
 *
 * <p>Typically, client applications would instantiate one single query logger (using its {@link
 ...
 * </pre>
 *
 * <p>Refer to the {@link Builder} documentation for more information on configuration settings for
 * the query logger.
 *
 * <p>Once registered, the query logger will log every {@link RegularStatement}, {@link
 ...
 * driver.
 *
 * <p>There is one log for each request to a Cassandra node; because the driver sometimes retries
 ...
 *
 * <p>For more flexibility, the query logger uses 3 different {@link Logger} instances:
 *
 * <p>
 *
 * <ol>
 *   <li>{@link #NORMAL_LOGGER}: used to log normal queries, i.e., queries that completed
 ...
 *   <li>{@link #ERROR_LOGGER}: used to log unsuccessful queries, i.e., queries that did not
 ...
 * <p>
 *
 * <p>The appropriate logger is chosen according to the following algorithm:
 *
 * <ol>
 *   <li>if an exception has been thrown: use {@link #ERROR_LOGGER};
 *   <li>otherwise, if the reported latency is greater than the configured threshold in
 *       milliseconds: use {@link #SLOW_LOGGER};
 *   <li>otherwise, use {@link #NORMAL_LOGGER}.
 * </ol>
 *
 * <p>
 *
 * <p>All loggers are activated by setting their levels to {@code DEBUG} or {@code TRACE} (including
 ...
 * <p>
 *
 * <p><strong>Constant thresholds vs. Dynamic thresholds</strong>
 *
 * <p>Currently the QueryLogger can track slow queries in two different ways: using a {@link
...
public abstract class QueryLogger implements LatencyTracker {
   ...
   *
   * <p>This logger is activated by setting its level to {@code DEBUG} or {@code TRACE}.
   ...
   * and value.
   *
   * <p>The name of this logger is {@code com.datastax.driver.core.QueryLogger.NORMAL}.
   */
   ...
   * and value.
   *
   * <p>The name of this logger is {@code com.datastax.driver.core.QueryLogger.SLOW}.
   */
   ...
   * exception.
   *
   * <p>The name of this logger is {@code com.datastax.driver.core.QueryLogger.ERROR}.
   */
   ...
   *
   * <p>This is a convenience method for {@code new QueryLogger.Builder()}.
   *
   ...
   *
   * <p>Dynamic thresholds are based on per-host latency percentiles, as computed by {@link
   * PercentileTracker}.
   */
  ...
  public static class Builder {
     ...
     *
     * <p>Note: You should either use {@link #withConstantThreshold(long) constant thresholds} or
     ...
     *
     * <p>Dynamic thresholds are based on latency percentiles, as computed by {@link
     * PercentileTracker}.
     *
     * <p>Note: You should either use {@link #withConstantThreshold(long) constant thresholds} or
     * {@link #withDynamicThreshold(PercentileTracker, double) dynamic thresholds}, not both.
