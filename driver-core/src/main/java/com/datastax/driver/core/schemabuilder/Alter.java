...
public class Alter implements StatementStart {
  ...
  public AlterColumn alterColumn(String columnName) {
    ...
    validateNotKeyWord(
        columnName,
        String.format(
            "The altered column name '%s' is not allowed because it is a reserved keyword",
            columnName));
  ...
  public AddColumn addColumn(String columnName) {
    ...
    validateNotKeyWord(
        columnName,
        String.format(
            "The new column name '%s' is not allowed because it is a reserved keyword",
            columnName));
  ...
  public AddColumn addStaticColumn(String columnName) {
    ...
    validateNotKeyWord(
        columnName,
        String.format(
            "The new static column name '%s' is not allowed because it is a reserved keyword",
            columnName));
   ...
   *
   * <p>Note that you cannot drop a column that is part of the primary key.
   *
  ...
  public SchemaStatement dropColumn(String columnName) {
    ...
    validateNotKeyWord(
        columnName,
        String.format(
            "The dropped column name '%s' is not allowed because it is a reserved keyword",
            columnName));
   ...
   *
   * <p>Note that you can only rename a column that is part of the primary key.
   *
  ...
  public RenameColumn renameColumn(String columnName) {
    ...
    validateNotKeyWord(
        columnName,
        String.format(
            "The renamed column name '%s' is not allowed because it is a reserved keyword",
            columnName));
  ...
  public String buildInternal() {
    String tableSpec = keyspaceName.isPresent() ? keyspaceName.get() + "." + tableName : tableName;
