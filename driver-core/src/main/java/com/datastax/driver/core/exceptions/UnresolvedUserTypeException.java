 ...
 *
 * <p>This exception can be raised when the driver is rebuilding its schema metadata, and a
 * user-defined type cannot be completely constructed due to some missing information. It should
 * only appear in the driver logs, never in client code. It shouldn't be considered as a severe
 * error as long as it only appears occasionally.
 */
