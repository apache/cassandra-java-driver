...
class SimpleJSONParser {
  ...
  public static List<String> parseStringList(String input) {
    if (input == null || input.isEmpty()) return Collections.<String>emptyList();
  ...
  public static Map<String, String> parseStringMap(String input) {
    if (input == null || input.isEmpty()) return Collections.<String, String>emptyMap();
  ...
  private char nextChar() {
    if (idx >= input.length()) throw new IllegalArgumentException("Invalid json input: " + input);
