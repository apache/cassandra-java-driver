 ...
 *
 * <p>Note that only idempotent statements will be speculatively retried, see {@link
...
public interface SpeculativeExecutionPolicy {
   ...
   *
   * <p>Each time a host is queried, {@link #nextExecution(Host)} is invoked to determine if and
