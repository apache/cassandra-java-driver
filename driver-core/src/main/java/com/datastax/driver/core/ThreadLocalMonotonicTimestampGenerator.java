...
/**
 * A timestamp generator that guarantees monotonically increasing timestamps on a per-thread basis,
...
public class ThreadLocalMonotonicTimestampGenerator extends LoggingMonotonicTimestampGenerator {
  ...
  // We're deliberately avoiding an anonymous subclass with initialValue(), because this can
  // introduce
