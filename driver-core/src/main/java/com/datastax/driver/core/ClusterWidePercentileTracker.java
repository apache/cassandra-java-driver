 ...
 *
 * <p>This gives you global latency percentiles for the whole cluster, meaning that latencies of
 * slower hosts will tend to appear in higher percentiles.
 */
public class ClusterWidePercentileTracker extends PercentileTracker {
  private volatile Cluster cluster;

  private ClusterWidePercentileTracker(
   ...
   *
   * @param highestTrackableLatencyMillis the highest expected latency. If a higher value is
   *     reported, it will be ignored and a warning will be logged. A good rule of thumb is to set
   *     it slightly higher than {@link SocketOptions#getReadTimeoutMillis()}.
   * @return the builder.
   */
  ...
  public static class Builder
    ...
    public ClusterWidePercentileTracker build() {
      return new ClusterWidePercentileTracker(
          highestTrackableLatencyMillis,
          numberOfSignificantValueDigits,
          minRecordedValues,
          intervalMs);
