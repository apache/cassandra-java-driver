...
public class FunctionMetadata {
  ...
  static FunctionMetadata build(
    ...
    return new FunctionMetadata(
        ksm, simpleName, arguments, body, calledOnNullInput, language, returnType);
  }
   ...
   *
   * <p>This method is equivalent to {@link #asCQLQuery} but the output is formatted.
   *
   ...
   *
   * <p>This method returns a single 'CREATE FUNCTION' query corresponding to this function
   * definition.
   *
   ...
   *
   * <p>This is the name of the function, followed by the names of the argument types between
   * parentheses, for example {@code sum(int,int)}.
   *
   * <p>Note that the returned signature is not qualified with the keyspace name.
   *
   ...
   *
   * <p>This is the name of the function, without arguments. Note that functions can be overloaded
   ...
   *
   * <p>This is {@code true} if the function was created with {@code CALLED ON NULL INPUT}, and
  ...
  public int hashCode() {
    return MoreObjects.hashCode(
        keyspace.getName(), arguments, body, calledOnNullInput, language, returnType);
  }
}
