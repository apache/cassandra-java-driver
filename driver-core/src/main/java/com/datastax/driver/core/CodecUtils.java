...
public final class CodecUtils {
   ...
   * literal.
   *
   * <p>In CQL, numeric DATE literals are longs (unsigned integers actually) between 0 and 2^32 - 1,
   * with the epoch in the middle; this method re-centers the epoch at 2^31.
   *
