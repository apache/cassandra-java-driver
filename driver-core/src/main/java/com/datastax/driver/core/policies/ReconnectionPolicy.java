 ...
 *
 * <p>Each time a node is detected dead (because a connection error occurs), a new {@code
 ...
 *
 * <p>Note that if the driver receives a push notification from the Cassandra cluster that a node is
 ...
 *
 * <p>The default {@link ExponentialReconnectionPolicy} policy is usually adequate.
 */
public interface ReconnectionPolicy {
  ...
  public interface ReconnectionSchedule {
     ...
     *
     * <p>This method will be called once when the host is detected down to schedule the first
