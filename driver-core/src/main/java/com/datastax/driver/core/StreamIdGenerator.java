 ...
 *
 * <p>Clients can borrow an id with {@link #next()}, and return it to the set with {@link
 ...
 *
 * <p>Implementation notes: we use an atomic long array where each bit represents an id. It is set
