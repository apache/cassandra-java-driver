 ...
 * not</b> see a preceding write at {@code QUORUM}. Do not use this policy unless you have
 * understood the cases where this can happen and are ok with that. It is also highly recommended to
 * always wrap this policy into {@link LoggingRetryPolicy} to log the occurrences of such
 * consistency breaks.
 *
 ...
 *
 * <p>The reasoning being this retry policy is the following one. If, based on the information the
 ...
 *     4.0.0. See our <a href="http://datastax.github.io/java-driver/upgrade_guide/">upgrade
 *     guide</a> to understand how to migrate existing applications that rely on this policy.
 */
@Deprecated
...
public class DowngradingConsistencyRetryPolicy implements RetryPolicy {
  ...
  public RetryDecision onReadTimeout(
    ...
    // supports the
    // normal consistency levels on the committing phase. So the main use case for CAS reads is
    // probably for
    // when you've timed out on a CAS write and want to make sure what happened. Downgrading in that
    // case
