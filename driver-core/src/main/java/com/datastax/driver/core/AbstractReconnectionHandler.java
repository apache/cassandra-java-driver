 ...
 *
 * <p>Concurrent attempts are handled via the {@link #currentAttempt} reference passed to the
 ...
 *
 * <p>This class is designed for concurrency, but instances must not be shared: each thread creates
...
abstract class AbstractReconnectionHandler implements Runnable {
  ...
  public AbstractReconnectionHandler(
      ...
      AtomicReference<ListenableFuture<?>> currentAttempt) {
