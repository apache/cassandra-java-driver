...
public class TypeCodecEncapsulationIntegrationTest extends CCMTestsSupport {
  ...
  // @formatter:off
  private static final TypeToken<NumberBox<Integer>> NUMBERBOX_OF_INTEGER_TOKEN =
      new TypeToken<NumberBox<Integer>>() {};
  private static final TypeToken<NumberBox<Long>> NUMBERBOX_OF_LONG_TOKEN =
      new TypeToken<NumberBox<Long>>() {};
  private static final TypeToken<NumberBox<Float>> NUMBERBOX_OF_FLOAT_TOKEN =
      new TypeToken<NumberBox<Float>>() {};
  private static final TypeToken<NumberBox<Double>> NUMBERBOX_OF_DOUBLE_TOKEN =
      new TypeToken<NumberBox<Double>>() {};
  private static final TypeToken<NumberBox<BigInteger>> NUMBERBOX_OF_BIGINTEGER_TOKEN =
      new TypeToken<NumberBox<BigInteger>>() {};
  private static final TypeToken<NumberBox<BigDecimal>> NUMBERBOX_OF_BIGDECIMAL_TOKEN =
      new TypeToken<NumberBox<BigDecimal>>() {};
  // @formatter:on

  private final String insertQuery =
      "INSERT INTO \"myTable\" (c_int, c_bigint, c_float, c_double, c_varint, c_decimal) VALUES (?, ?, ?, ?, ?, ?)";
  ...
  public void createBuiltStatements() throws Exception {
    ...
    selectStmt =
        select("c_int", "c_bigint", "c_float", "c_double", "c_varint", "c_decimal")
            .from("\"myTable\"")
  ...
  private class NumberBoxCodec<T extends Number> extends TypeCodec<NumberBox<T>> {
    ...
    @Override
    public ByteBuffer serialize(NumberBox<T> value, ProtocolVersion protocolVersion)
        throws InvalidTypeException {
      return numberCodec.serialize(value.getNumber(), protocolVersion);
    }

    @Override
    public NumberBox<T> deserialize(ByteBuffer bytes, ProtocolVersion protocolVersion)
        throws InvalidTypeException {
