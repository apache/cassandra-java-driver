...
public class CustomRetryPolicyIntegrationTest extends AbstractRetryPolicyIntegrationTest {
  ...
  public void should_rethrow_on_server_side_error(
  ...
  /**
   * Ignores read and write timeouts, and retries at most once on unavailable. Rethrows for
   * unexpected errors.
   */
  static class CustomRetryPolicy implements RetryPolicy {
    ...
    public RetryDecision onUnavailable(
        ...
        int aliveReplica,
        int nbRetry) {
      return (nbRetry == 0) ? RetryDecision.retry(cl) : RetryDecision.rethrow();
    }
