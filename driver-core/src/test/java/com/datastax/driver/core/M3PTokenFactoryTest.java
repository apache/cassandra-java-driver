...
public class M3PTokenFactoryTest {
  ...
  public void should_split_range() {
    List<Token> splits =
        factory.split(
            ...
            3);
    assertThat(splits)
        .containsExactly(factory.fromString("-4611686018427387904"), factory.fromString("0"));
  }
  ...
  public void should_split_range_that_wraps_around_the_ring() {
    ...
    assertThat(splits)
        .containsExactly(
            factory.fromString("-9223372036854775807"), factory.fromString("-4611686018427387903"));
  }
  ...
  public void should_split_range_when_division_not_integral() {
    ...
    assertThat(splits).containsExactly(factory.fromString("4"), factory.fromString("8"));
  }
  ...
  public void should_split_range_producing_empty_splits_near_ring_end() {
    ...
    assertThat(splits).containsExactly(maxToken, maxToken);

    splits = factory.split(minToken, factory.fromString("-9223372036854775807"), 3);
    assertThat(splits)
        .containsExactly(
            factory.fromString("-9223372036854775807"), factory.fromString("-9223372036854775807"));
  }
  ...
  public void should_split_whole_ring() {
    ...
    assertThat(splits)
        .containsExactly(
            factory.fromString("-3074457345618258603"), factory.fromString("3074457345618258602"));
  }
}
