 ...
 *
 * <p>These values have no particular meaning, the goal is just to have an instance that can be used
 * in automated tests.
 */
public class PrimitiveTypeSamples {
  ...
  static Map<DataType, Object> samples(ProtocolVersion protocolVersion) {
    try {
      ...
      ImmutableMap<DataType, Object> data =
      ...
      // Duration is excluded because it can't be used in collections and udts.   It is tested
      // separately
