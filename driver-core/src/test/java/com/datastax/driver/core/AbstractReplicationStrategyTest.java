...
public class AbstractReplicationStrategyTest {
  ...
  protected static class HostMock extends Host {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof HostMock)) return false;
  ...
  /**
   * Convenience method to quickly create a mock host by a given address. Specified address must be
   * accessible, otherwise a RuntimeException is thrown
   */
  ...
  /**
   * Convenience method to quickly create a mock host by the given address located in the given
   * datacenter/rack
   */
  ...
  /**
   * Convenience method to cast a Host object into a MockHost. Returns null if parameter host is not
   * a mock
   */
  ...
  /**
   * Convenience method to quickly retrieve a mock host's address as specified if created by the
   * <code>host(...)</code> methods. Returns null if given host is not a mock.
   */
