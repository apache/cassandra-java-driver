...
public class QueryOptionsTest {
  ...
  /**
   * Validates that statements are only prepared on one node when {@link
   * QueryOptions#setPrepareOnAllHosts(boolean)} is set to false.
   *
  ...
  /**
   * Validates that statements are prepared on one node when {@link
   * QueryOptions#setPrepareOnAllHosts(boolean)} is set to true.
   *
   * @test_category prepared_statements:prepared
  ...
  /**
   * Validates that statements are prepared on one node when {@link
   * QueryOptions#setPrepareOnAllHosts(boolean)} is not set.
   *
   * @test_category prepared_statements:prepared
   * @expected_result all nodes prepared the query.
   * @jira_ticket JAVA-797
  ...
  /**
   * Validates that statements are reprepared when a node comes back up when {@link
   * QueryOptions#setReprepareOnUp(boolean)} is set to true.
   *
   * @test_category prepared_statements:prepared
  ...
  /**
   * Validates that statements are reprepared when a node comes back up with the default
   * configuration.
   *
   * @test_category prepared_statements:prepared
   * @expected_result reprepare query on the restarted node.
  ...
  /**
   * Validates that statements are not reprepared when a node comes back up when {@link
   * QueryOptions#setReprepareOnUp(boolean)} is set to false.
   *
   * @test_category prepared_statements:prepared
