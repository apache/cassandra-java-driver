...
public class DurationTest {
  ...
  public void testFromStringWithStandardPattern() {
    ...
    assertThat(Duration.from("30h20m"))
        .isEqualTo(Duration.newInstance(0, 0, 30 * NANOS_PER_HOUR + 20 * NANOS_PER_MINUTE));
    ...
    assertThat(Duration.from("1950us"))
        .isEqualTo(Duration.newInstance(0, 0, 1950 * NANOS_PER_MICRO));
    assertThat(Duration.from("1950µs"))
        .isEqualTo(Duration.newInstance(0, 0, 1950 * NANOS_PER_MICRO));
    assertThat(Duration.from("1950000ns")).isEqualTo(Duration.newInstance(0, 0, 1950000));
    assertThat(Duration.from("1950000NS")).isEqualTo(Duration.newInstance(0, 0, 1950000));
    assertThat(Duration.from("-1950000ns")).isEqualTo(Duration.newInstance(0, 0, -1950000));
    assertThat(Duration.from("1y3mo2h10m"))
        .isEqualTo(Duration.newInstance(15, 0, 130 * NANOS_PER_MINUTE));
  }
  ...
  public void testFromStringWithIso8601Pattern() {
    ...
    assertThat(Duration.from("PT30H20M"))
        .isEqualTo(Duration.newInstance(0, 0, 30 * NANOS_PER_HOUR + 20 * NANOS_PER_MINUTE));
    ...
    assertThat(Duration.from("P1Y3MT2H10M"))
        .isEqualTo(Duration.newInstance(15, 0, 130 * NANOS_PER_MINUTE));
  }
  ...
  public void testFromStringWithIso8601AlternativePattern() {
    ...
    assertThat(Duration.from("P0001-00-00T02:00:00"))
        .isEqualTo(Duration.newInstance(12, 0, 2 * NANOS_PER_HOUR));
    assertThat(Duration.from("-P0001-02-00T00:00:00")).isEqualTo(Duration.newInstance(-14, 0, 0));
    assertThat(Duration.from("P0000-00-02T00:00:00")).isEqualTo(Duration.newInstance(0, 2, 0));
    assertThat(Duration.from("P0000-00-00T30:00:00"))
        .isEqualTo(Duration.newInstance(0, 0, 30 * NANOS_PER_HOUR));
    assertThat(Duration.from("P0000-00-00T30:20:00"))
        .isEqualTo(Duration.newInstance(0, 0, 30 * NANOS_PER_HOUR + 20 * NANOS_PER_MINUTE));
    assertThat(Duration.from("P0000-00-00T00:20:00"))
        .isEqualTo(Duration.newInstance(0, 0, 20 * NANOS_PER_MINUTE));
    assertThat(Duration.from("P0000-00-00T00:00:56"))
        .isEqualTo(Duration.newInstance(0, 0, 56 * NANOS_PER_SECOND));
    assertThat(Duration.from("P0001-03-00T02:10:00"))
        .isEqualTo(Duration.newInstance(15, 0, 130 * NANOS_PER_MINUTE));
  }
