...
public class RPTokenFactoryTest {
  ...
  public void should_split_range_that_wraps_around_the_ring() {
    ...
    assertThat(splits)
        .containsExactly(
            factory.fromString("0"), factory.fromString("42535295865117307932921825928971026432"));
  }
  ...
  public void should_split_range_producing_empty_splits_near_ring_end() {
    ...
    assertThat(splits).containsExactly(factory.fromString("0"), factory.fromString("0"));
  }
