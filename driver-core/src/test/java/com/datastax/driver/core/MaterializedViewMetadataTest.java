...
public class MaterializedViewMetadataTest extends CCMTestsSupport {
  ...
  public void should_create_view_metadata() {
    ...
    assertThat(mv)
        ...
        .isEqualTo(table.getView("monthlyhigh"));
    ...
    assertThat(mv.getColumns().get(3))
        .isNotNull()
        .hasName("score")
        .isClusteringColumn()
  ...
  /**
   * Validates that a materialized view is properly retrieved and parsed when using quoted
   * identifiers.
   *
   * @test_category metadata, materialized_view
   * @jira_ticket JAVA-825
  ...
  public void should_create_view_metadata_with_quoted_identifiers() {
    ...
    MaterializedViewMetadata mv =
        cluster().getMetadata().getKeyspace(keyspace).getMaterializedView("\"Mv1\"");
    ...
    assertThat(table.getColumns().get(0))
        .isNotNull()
        .hasName("theKey")
        .isPartitionKey()
        .hasType(cint());
    ...
    assertThat(mv.getColumns().get(0))
        .isNotNull()
        .hasName("theKey")
        .isPartitionKey()
        .hasType(cint());
    assertThat(mv.getColumns().get(1))
        .isNotNull()
        .hasName("the;Clustering")
        .isClusteringColumn()
        .hasType(cint());
    assertThat(mv.getColumns().get(2))
        .isNotNull()
        .hasName("the Value")
        .isRegularColumn()
        .hasType(cint());
