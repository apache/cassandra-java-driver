...
public class PreparedStatementInvalidationTest extends CCMTestsSupport {
    ...
    public void should_update_statement_id_when_metadata_changed_across_sessions() {
        ...
        MD5Digest id1a = ps1.getPreparedId().getId();
        MD5Digest id2a = ps2.getPreparedId().getId();
        ...
        MD5Digest id1b = ps1.getPreparedId().getId();
        MD5Digest id2b = ps2.getPreparedId().getId();
