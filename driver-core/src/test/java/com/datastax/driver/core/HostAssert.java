...
public class HostAssert extends AbstractAssert<HostAssert, Host> {
  ...
  public HostAssert isReconnectingFromDown() {
    assertThat(
            actual.getReconnectionAttemptFuture() != null
                && !actual.getReconnectionAttemptFuture().isDone())
        .isTrue();
    return this;
  }
