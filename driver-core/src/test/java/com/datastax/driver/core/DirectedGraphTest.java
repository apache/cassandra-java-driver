...
public class DirectedGraphTest {
  ...
  private Comparator<String> alphaComparator =
  ...
  public void should_sort_complex_graph() {
    ...
    DirectedGraph<String> g =
        new DirectedGraph<String>(alphaComparator, "A", "B", "C", "D", "E", "F", "G", "H");
    g.addEdge("H", "F");
    g.addEdge("G", "E");
    g.addEdge("H", "D");
    g.addEdge("F", "D");
  ...
  public void should_sort_complex_custom_comparator() {
    // Version of should_sort_complex_graph using a custom comparator based on ordering largest
    // values first.
    // This is counter to how hashmaps should usually behave, so this should help ensure that the
    // comparator is
    // being used.
    Comparator<Integer> highFirst =
    ...
    // 5 comes before 10 even though they appear at the same depth.  This happens because 5's (7)
    // dependency
