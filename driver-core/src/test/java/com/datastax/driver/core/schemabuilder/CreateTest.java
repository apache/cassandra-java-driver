...
import static com.datastax.driver.core.schemabuilder.SchemaBuilder.Direction;
import static com.datastax.driver.core.schemabuilder.SchemaBuilder.KeyCaching;
import static com.datastax.driver.core.schemabuilder.SchemaBuilder.allRows;
...
import static com.datastax.driver.core.schemabuilder.SchemaBuilder.millisecs;
import static com.datastax.driver.core.schemabuilder.SchemaBuilder.noSpeculativeRetry;
...
public class CreateTest {
  ...
  @Test(groups = "unit")
  public void should_create_table_with_composite_partition_key_and_clustering_keys()
      throws Exception {
    // When
    SchemaStatement statement =
        createTable("test")
  ...
  public void should_fail_when_blank_clustering_order_column_provided() throws Exception {
    createTable("test")
        ...
        .addColumn("name", DataType.text())
        .withOptions()
        .clusteringOrder("", Direction.DESC);
  }

  @Test(groups = "unit", expectedExceptions = IllegalArgumentException.class)
  public void should_fail_when_clustering_order_column_does_not_match_declared_clustering_keys()
      throws Exception {
    createTable("test")
        .addPartitionKey("id", DataType.bigint())
        .addClusteringColumn("col1", DataType.uuid())
        ...
        .addColumn("name", DataType.text())
        .withOptions()
        .clusteringOrder("col3", Direction.ASC);
  }
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp =
          "The '\\[pk\\]' columns can not be declared as partition keys and clustering keys at the same time")
  public void should_fail_if_same_partition_and_clustering_column() throws Exception {
    createTable("test")
        .addPartitionKey("pk", DataType.bigint())
        .addClusteringColumn("pk", DataType.bigint())
        .getQueryString();
  }
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The '\\[pk\\]' columns can not be declared as partition keys and simple columns at the same time")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The '\\[cluster\\]' columns can not be declared as clustering keys and simple columns at the same time")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The '\\[pk\\]' columns can not be declared as partition keys and static columns at the same time")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The '\\[cluster\\]' columns can not be declared as clustering keys and static columns at the same time")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The '\\[col\\]' columns can not be declared as simple columns and static columns at the same time")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "The table 'test' cannot declare static columns '\\[stat\\]' without clustering columns")
  ...
  @Test(
      ...
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp =
          "The partition key name 'ADD' is not allowed because it is a reserved keyword")
  ...
  @Test(
      ...
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp =
          "The clustering column name 'ADD' is not allowed because it is a reserved keyword")
  ...
  @Test(
      ...
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp =
          "The column name 'ADD' is not allowed because it is a reserved keyword")
  ...
  @Test(
      ...
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp =
          "The static column name 'ADD' is not allowed because it is a reserved keyword")
  ...
  @Test(
      ...
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp =
          "Cannot create table 'test' with compact storage and static columns '\\[stat\\]'")
  public void should_fail_creating_table_with_static_columns_and_compact_storage()
      throws Exception {
    createTable("test")
        .addPartitionKey("pk", DataType.bigint())
        .addClusteringColumn("cluster", DataType.uuid())
