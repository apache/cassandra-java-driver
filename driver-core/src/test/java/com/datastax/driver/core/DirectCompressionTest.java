...
public class DirectCompressionTest extends CompressionTest {
  ...
  /**
   * Validates that a session can be established using snappy compression and executes some queries
   * that inserts and retrieves data using that session().
   *
  ...
  /**
   * Validates that a session can be established using lz4 compression and executes some queries
   * that inserts and retrieves data using that session().
   *
   * @test_category connection:compression
   * @expected_result session established and queries made successfully using it.
