...
/**
 * This tests that the CodecRegistry is able to create codecs on the fly for nested UDTs and tuples
 * received from a ResultSet, i.e. the first time the registry encounters the UDT or tuple, it's
 * coming from a ResultSet, not from the Cluster's metadata.
 *
