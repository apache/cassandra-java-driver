...
Annotate a DAO method with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Select.html[@Select] to generate a query that selects one or more rows, and maps them to link:../../entities[Entities]:
...
If the annotation doesn't have a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Select.html#customWhereClause--[customWhereClause()], the mapper defaults to a selection by primary key (partition key + clustering columns).
...
If the annotation has a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Select.html#customWhereClause--[customWhereClause()], it completely replaces the WHERE clause.
...
* a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/PagingIterable.html[PagingIterable] of the entity class.
...
Note that for iterables, you need to switch to the asynchronous equivalent https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/MappedAsyncPagingIterable.html[MappedAsyncPagingIterable].
+
[source,java]
----
  @Select
...
* a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/dse/driver/api/mapper/reactive/MappedReactiveResultSet.html[MappedReactiveResultSet] of the entity class.
+
[source,java]
----
  @Select(customWhereClause = "description LIKE :searchString")
