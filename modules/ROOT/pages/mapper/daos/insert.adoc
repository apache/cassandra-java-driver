...
Annotate a DAO method with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Insert.html[@Insert] to generate a query that inserts an link:../../entities[Entity]:
...
This is intended for cases where you intend to inspect data associated with the result, such as https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/cql/ResultSet.html#getExecutionInfo--[ResultSet#getExecutionInfo()]:
+
[source,java]
----
  @Insert
