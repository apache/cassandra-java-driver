...
Interface annotated with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Dao.html[@Dao].

* interface-level annotations:
 ** https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html[@DefaultNullSavingStrategy]
...
* instantiated from a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/DaoFactory.html[@DaoFactory] method on the mapper.
...
It must be annotated with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Dao.html[@Dao]:
...
Note that interfaces that declare generic type variables should not be annotated with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Dao.html[@Dao].

In addition to inheriting methods from parent interfaces, interface-level annotations such as https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/DefaultNullSavingStrategy.html[@DefaultNullSavingStrategy] are also inherited:
...
Annotation priority is driven by proximity to the https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Dao.html[@Dao]-annotated interface.
For example:
...
To control how the hierarchy is scanned, annotate interfaces with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/HierarchyScanStrategy.html[@HierarchyScanStrategy].
