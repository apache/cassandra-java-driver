...
Annotate a DAO method with https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/mapper/annotations/Update.html[@Update] to generate a query that updates one or more link:../../entities[entities]:
...
Note that for result sets, you need to switch to the asynchronous equivalent https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/cql/AsyncResultSet.html[AsyncResultSet].
+
[source,java]
----
  @Update
