...
If you are using the driver's xref:mapper/index.adoc[object mapper], our recommendation is to declare the mapper processor in the xref:mapper/config/index.adoc#maven[annotationProcessorPaths] section of the compiler plugin configuration.
