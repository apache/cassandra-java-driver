...
All statement types share a https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/cql/StatementBuilder.html[common set of execution attributes], that can be set through either setters or a builder:
