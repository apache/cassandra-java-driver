...
See the xref:core/configurationReference.adoc[reference configuration].
...
To find out which metrics are available, see the xref:core/configurationReference.adoc[reference configuration].
...
Again, see the xref:core/configurationReference.adoc[reference configuration] for more details.
