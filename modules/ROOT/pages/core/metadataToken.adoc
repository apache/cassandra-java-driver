...
https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--[session.getMetadata().getTokenMap()]
...
https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--[Metadata#getTokenMap] returns information about the tokens used for data replication.
...
Because token metadata can be disabled, the resulting https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/metadata/TokenMap.html[TokenMap] object is wrapped in an `Optional`;
...
If it is disabled at startup, https://docs.datastax.com/en/drivers/java/4.13/com/datastax/oss/driver/api/core/metadata/Metadata.html#getTokenMap--[Metadata#getTokenMap] will stay empty, and token-aware routing won't work (requests will be sent to a non-optimal coordinator).
...
The keyspace-specific information in `TokenMap` (all methods with a `CqlIdentifier` argument) relies on xref:core/schemaMetadata.adoc[schema metadata].
