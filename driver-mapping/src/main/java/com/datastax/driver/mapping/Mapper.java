...
import static com.datastax.driver.mapping.Mapper.Option.Type.KEYSPACE;
...
public class Mapper<T> {
    ...
    public static abstract class Option {
        ...
        enum Type {TTL, TIMESTAMP, CL, TRACING, SAVE_NULL_FIELDS, KEYSPACE}
        ...
        /**
         * Creates a new Option object to specify the keyspace to use. This is valid for save, delete and get
         * operations.
         * <p/>
         * If this option is not specified, it defaults to {@code null} (use the keyspace defined in the session or the
         * {@link com.datastax.driver.mapping.annotations.Table} annotation).
         *
         * @param keyspace the name of the keyspace.
         * @return the option.
         */
        public static Option keyspace(String keyspace) {
        ...
        static class Keyspace extends Option {
