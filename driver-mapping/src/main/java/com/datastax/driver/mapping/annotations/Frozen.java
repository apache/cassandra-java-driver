 ...
 *
 * <p>This annotation is purely informational at this stage, the validity of the declaration is not
 * checked. But will become useful when a schema generation feature is added to the mapper.
 * Therefore it is a good idea to keep frozen declarations up-to-date.
 *
 * @see FrozenKey
 * @see FrozenValue
 */
