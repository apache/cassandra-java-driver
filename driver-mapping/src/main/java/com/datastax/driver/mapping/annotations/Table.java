...
public @interface Table {
   ...
   *
   * @return the consistency level to use for the write operations provded by the {@link Mapper}
   *     class.
   */
   ...
   *
   * @return the consistency level to use for the read operations provded by the {@link Mapper}
   *     class.
   */
