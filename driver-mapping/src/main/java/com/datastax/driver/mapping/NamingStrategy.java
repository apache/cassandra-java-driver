 ...
 * class.
 *
 * <p>This will be used for any property that doesn't have an explicit name provided (via a {@link
 * Column} or {@link Field} annotation).
 *
 * <p>If you need to implement your own strategy, the most straightforward approach is to build a
