 ...
 * method of a Java bean property of a class annotated by {@link UDT} will be mapped by default to a
 * UDT field having the same name than this Java field / bean property unless that Java field or
 * method has the {@link Transient} annotation. As such, this annotation is mainly useful when the
...
public @interface Field {
  /**
   * Name of the column being mapped in Cassandra. By default, the name of the Java field or bean
   * property will be used.
   *
   * @return the name of the mapped column in Cassandra, or {@code ""} to use the field name.
   */
  String name() default "";
