...
public class MapperInvalidAnnotationsTest {
  ...
  public void should_throw_IAE_when_Table_annotation_not_found_on_entity_class() throws Exception {
    AnnotationParser.parseEntity(Invalid1.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_UDT_annotation_not_found_on_udt_class() throws Exception {
    AnnotationParser.parseUDT(Invalid1.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_UDT_annotation_found_on_entity_class() throws Exception {
    AnnotationParser.parseEntity(Invalid2.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Table_annotation_found_on_udt_class() throws Exception {
    AnnotationParser.parseUDT(Invalid2.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Accessor_annotation_found_on_entity_class() throws Exception {
    AnnotationParser.parseEntity(Invalid3.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Accessor_annotation_found_on_udt_class() throws Exception {
    AnnotationParser.parseUDT(Invalid4.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Accessor_annotation_not_found_on_accessor_class()
      throws Exception {
  ...
  @Test(
      groups = "unit",
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Annotation @Field is not allowed on property 'invalid'")
  public void should_throw_IAE_when_Field_annotation_found_on_entity_class_field()
      throws Exception {
    AnnotationParser.parseEntity(Invalid8.class, null, mappingManager);
  }
  ...
  @Test(
      groups = "unit",
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Annotation @Column is not allowed on property 'invalid'")
  public void should_throw_IAE_when_Column_annotation_found_on_udt_class_field() throws Exception {
    AnnotationParser.parseUDT(Invalid9.class, null, mappingManager);
  }

  @Table(name = "foo", keyspace = "ks")
  static class Invalid10 {

    @PartitionKey @ClusteringColumn int invalid;
  }
  ...
  public void should_throw_IAE_when_PartitionKey_and_ClusteringColumn_on_same_property()
      throws Exception {
    AnnotationParser.parseEntity(Invalid10.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Computed_and_Column_on_same_property() throws Exception {
    AnnotationParser.parseEntity(Invalid11.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_Computed_with_empty_value() throws Exception {
    AnnotationParser.parseEntity(Invalid12.class, null, mappingManager);
  }
  ...
  public void should_throw_IAE_when_PartitionKey_with_wrong_order() throws Exception {
    AnnotationParser.parseEntity(Invalid13.class, null, mappingManager);
  }
  ...
  @Test(
      groups = "unit",
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Property 'notReadable' is not readable")
  public void should_throw_IAE_when_unreadable_property() throws Exception {
    AnnotationParser.parseEntity(Invalid14.class, null, mappingManager);
  }
  ...
  @Test(
      groups = "unit",
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Property 'notWritable' is not writable")
  public void should_throw_IAE_when_unwritable_property() throws Exception {
    AnnotationParser.parseEntity(Invalid15.class, null, mappingManager);
  }
}
