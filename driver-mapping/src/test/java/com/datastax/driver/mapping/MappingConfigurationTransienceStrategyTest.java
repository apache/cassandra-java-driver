...
/**
 * Test for JAVA-1310 - validate ability configure property mapping strategy - whitelist vs.
 * blacklist
 */
public class MappingConfigurationTransienceStrategyTest extends CCMTestsSupport {
  ...
  public void should_map_only_non_transient() {
    ...
    // then will succeed mapping since non-transient fields (k, v) exist in table and transient one
    // (notAColumn)
    // is not used
