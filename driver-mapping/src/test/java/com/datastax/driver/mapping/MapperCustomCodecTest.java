...
public class MapperCustomCodecTest extends CCMTestsSupport {
  ...
  public Cluster.Builder createClusterBuilder() {
    return Cluster.builder().withCodecRegistry(new CodecRegistry().register(new CustomInt.Codec()));
  }
  ...
  public void should_fail_when_invalid_codec_type_mapping() {
    Mapper<Data1InvalidCodecTypeMapping> mapper =
        new MappingManager(session()).mapper(Data1InvalidCodecTypeMapping.class);
  ...
  public void should_fail_when_invalid_codec_type_mapping_in_accessor() {
    Data1AccessorInvalidCodecTypeMapping accessor =
        new MappingManager(session()).createAccessor(Data1AccessorInvalidCodecTypeMapping.class);
  ...
  public void should_be_able_to_use_parameterized_type() {
    Mapper<Data1ParameterizedType> mapper =
        new MappingManager(session()).mapper(Data1ParameterizedType.class);
  ...
  public static class Data1 {
    @PartitionKey private CustomInt i;
  ...
  public interface Data1Accessor {
    ...
    void setL(@Param("i") int i, @Param(value = "l", codec = CustomLong.Codec.class) CustomLong l);
  }
  ...
  public interface Data1AccessorNoDefaultConstructor {
    ...
    @Query("update data1 set l = :l where i = :i")
    void setL(
        @Param("i") int i, @Param(value = "l", codec = NoDefaultConstructorCodec.class) long l);
  }
  ...
  public interface Data1AccessorInvalidCodecTypeMapping {
    ...
    @Query("update data1 set l = :l where i = :i")
    void setL(
        @Param("i") int i, @Param(value = "l", codec = OptionalOfString.class) Optional<Long> l);
  }
  ...
  public static class Data3 {
    ...
    @FrozenValue private Map<CustomInt, Holder> data;
  ...
  public static class CustomInt {
    ...
    public static class Codec extends TypeCodec<CustomInt> {
      ...
      @Override
      public ByteBuffer serialize(CustomInt value, ProtocolVersion protocolVersion)
          throws InvalidTypeException {
        return TypeCodec.cint().serialize(value.value, protocolVersion);
      }

      @Override
      public CustomInt deserialize(ByteBuffer bytes, ProtocolVersion protocolVersion)
          throws InvalidTypeException {
  ...
  public static class CustomLong {
    ...
    public static class Codec extends TypeCodec<CustomLong> {
      ...
      @Override
      public ByteBuffer serialize(CustomLong value, ProtocolVersion protocolVersion)
          throws InvalidTypeException {
        return TypeCodec.bigint().serialize(value.value, protocolVersion);
      }

      @Override
      public CustomLong deserialize(ByteBuffer bytes, ProtocolVersion protocolVersion)
          throws InvalidTypeException {
  ...
  /**
   * This class is a copy of GuavaOptionalCodec declared in the extras module, to avoid circular
