...
/**
 * Tests for JAVA-541 Add polymorphism support to object mapper JAVA-636 Allow @Column annotations
 * on getters/setters as well as fields
 */
...
public class MapperPolymorphismTest extends CCMTestsSupport {
  ...
  static class Circle extends Shape {
    ...
    @Transient private double _radius;
  ...
  /**
   * Validates that fields and methods from a parent class {@link Shape} are inherited for a mapped
   * entity class {@link Circle}.
   *
   * <p>It also ensures that methods overridden in {@link Circle} are given precedence and that
   * their annotations are used. In the case of circle, the {@link Circle#getId()} method overrides
   * the parent and specifies a {@link Column} annotation that will be used instead of the parents
   * annotation ('wrong').
   *
   * <p>Lastly, it defines another column 'radius' that is defined by having {@link
   * Circle#getRadius} and {@link Circle#setRadius} properties, while it has a {@link Transient}
   * field '_radius' that should not be pulled in by the mapper.
   *
  ...
  /**
   * Validates that property methods such as {@link Rectangle#getWidth} and {@link
   * Rectangle#getHeight} are not considered as they are marked as {@link Transient}. It also
   * ensures that overridden method {@link Rectangle#getArea} inherits its parent's {@link
  ...
  /**
   * Validates that {@link Square} inherits its properties from its parent class {@link Rectangle}
   * and its parent's class {@link Shape} and that its methods {@link Square#getBottomLeft} and
   * {@link Square#getHeight} inherit annotations from its parent.
   *
   * @test_category object_mapper
   * @jira_ticket JAVA-541, JAVA-636
   */
  ...
  /**
   * Validates that {@link Sphere} inherits its properties from its parent class {@link Circle} and
   * most importantly can specialize the type of {@link Sphere#center} to a {@link Point3D} instead
   * of a {@link Point2D}.
   *
   * @test_category object_mapper
   * @jira_ticket JAVA-541, JAVA-636
