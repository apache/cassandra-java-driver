...
public class MailboxServiceTest {
    ...
    private MavenArtifactProvisionOption driverBundle = mavenBundle("com.datastax.cassandra", "cassandra-driver-core", projectVersion());

    private MavenArtifactProvisionOption guavaBundle = mavenBundle("com.google.guava", "guava", "14.0.1");

    private MavenArtifactProvisionOption nettyBundle = mavenBundle("io.netty", "netty", "3.9.0.Final");

    private CompositeOption defaultOptions = new CompositeOption() {
