...
public interface CodeGeneratorFactory {
   ...
   *
   * <p>By default, this calls {@link #newDaoMethodFactory(ExecutableElement)} for each DAO factory
   * method.
   */
  ...
  PartialClassGenerator newDaoMethodFactory(ExecutableElement methodElement);
