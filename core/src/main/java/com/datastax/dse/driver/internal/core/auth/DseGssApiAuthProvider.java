...
public class DseGssApiAuthProvider extends DseGssApiAuthProviderBase {
  ...
  protected GssApiOptions getOptions(
    ...
    optionsBuilder.withLoginConfiguration(fetchLoginConfiguration(loginConfigurationMap));
   ...
   * user.
   */
  private static Configuration fetchLoginConfiguration(Map<String, String> options) {
