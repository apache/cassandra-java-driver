 ...
 *     This type was preserved for backward compatibility, but {@link
 *     ProgrammaticPlainTextAuthProvider} should be used instead.
 */
@Deprecated
public class DseProgrammaticPlainTextAuthProvider extends ProgrammaticPlainTextAuthProvider {
  ...
  public DseProgrammaticPlainTextAuthProvider(
    ...
    super(username, password, authorizationId);
  }
}
