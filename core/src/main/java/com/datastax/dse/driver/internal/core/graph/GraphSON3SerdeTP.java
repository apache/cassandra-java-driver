...
public class GraphSON3SerdeTP {
   ...
   * TinkerPopJacksonModule} because of the specific typing format used in GraphSON.
   */
  public static class DseGraphModule extends TinkerPopJacksonModule {
    ...
    public DseGraphModule() {
      ...
      addSerializer(
          DefaultPoint.class, new GraphSON3SerdeTP.DseGraphModule.PointGeometrySerializer());
      addSerializer(
          DefaultLineString.class,
          new GraphSON3SerdeTP.DseGraphModule.LineStringGeometrySerializer());
      addSerializer(
          DefaultPolygon.class, new GraphSON3SerdeTP.DseGraphModule.PolygonGeometrySerializer());
      addSerializer(
          Distance.class, new GraphSON3SerdeTP.DseGraphModule.DistanceGeometrySerializer());
      // override TinkerPop's P predicates because of DSE's Search and Geo predicates
      addSerializer(P.class, new GraphSON3SerdeTP.DseGraphModule.DsePJacksonSerializer());
      addSerializer(
          EditDistance.class, new GraphSON3SerdeTP.DseGraphModule.EditDistanceSerializer());

      addDeserializer(
          DefaultLineString.class,
          new GraphSON3SerdeTP.DseGraphModule.LineStringGeometryDeserializer());
      addDeserializer(
          DefaultPoint.class, new GraphSON3SerdeTP.DseGraphModule.PointGeometryDeserializer());
      addDeserializer(
          DefaultPolygon.class, new GraphSON3SerdeTP.DseGraphModule.PolygonGeometryDeserializer());
      addDeserializer(
          Distance.class, new GraphSON3SerdeTP.DseGraphModule.DistanceGeometryDeserializer());
      // override TinkerPop's P predicates because of DSE's Search and Geo predicates
  ...
  public static class DriverObjectsModule extends SimpleModule {
    ...
    public DriverObjectsModule() {
      ...
      addSerializer(ObjectGraphNode.class, new ObjectGraphNodeGraphSON3Serializer());
    }

    static final class ObjectGraphNodeGraphSON3Serializer extends StdSerializer<ObjectGraphNode> {
