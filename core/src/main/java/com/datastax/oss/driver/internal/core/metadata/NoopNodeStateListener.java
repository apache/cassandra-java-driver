...
/**
 * Default node state listener implementation with empty methods. This implementation is used when
 * no listeners were registered, neither programmatically nor through the configuration.
 */
@ThreadSafe
